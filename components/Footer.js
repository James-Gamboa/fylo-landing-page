      ...
      <div className="flex flex-col justify-start space-y-6 md:flex-row md:justify-between md:items-start max-w-6xl">
        ...
        <div className="flex flex-col space-y-4">
          <ul className="flex flex-col ">
            <li>
              <Link href="/" passHref>
                <p className="text-sm text-white hover:text-brightBlue">
                  About us
                </p>
              </Link>
            </li>
            <li>
              <Link href="/" passHref>
                <p className="text-sm text-white hover:text-brightBlue">Jobs</p>
              </Link>
            </li>
            <li>
              <Link href="/" passHref>
            ...
            <li>
              <Link href="/" passHref>
                <p className="text-sm text-white hover:text-brightBlue">Blog</p>
              </Link>
            </li>
          </ul>
        </div>
